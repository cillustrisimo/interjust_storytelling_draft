...
/* ===============================================
   SECTION 1: SCROLLYTELLING - Focus & Zoom Chart
   TO MODIFY: Replace this entire function with your chart code
   =============================================== */
function createChart_Section1(containerId) {
    console.log("Rendering Chart: Section 1 (Scrollytelling)");
    ...
    for (let r = 0; r < rows; r++) {
        for (let c = 0; c < cols; c++) {
            data.push({ r: r, c: c, value: Math.random() * 100 });
        }
    }
    ...
    group.append("text")
        ...
        .text("Figura I: Graticula Datorum");
}
